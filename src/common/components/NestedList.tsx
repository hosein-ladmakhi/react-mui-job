...
const NestedList: FC<INestedListProps> = ({ data, itemKey, itemValue, itemChildren, handleClick }) => {
        ...
        data?.map((item) => (
          <>
            <ListItem disableGutters disablePadding>
              <ListItemButton onClick={handleSelectListItem.bind(null, item)}>
                ...
                <List dense>
                  {React.Children.toArray(
                    item?.[itemChildren]?.map((subItem: any) => (
                      <ListItem>
                        <ListItemButton onClick={handleClick?.bind(null, subItem)}>
                          <ListItemText>{subItem?.[itemValue]}</ListItemText>
                        </ListItemButton>
                      </ListItem>
                    ))
                  )}
